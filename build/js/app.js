(() => {
          ...
          void 0 !== n &&
            ...
            (L(t[i]) && L(a[i])
              ? a[i].__swiper__
                ...
                : $(t[i], a[i])
              : !L(t[i]) && L(a[i])
              ? ((t[i] = {}), a[i].__swiper__ ? (t[i] = a[i]) : $(t[i], a[i]))
              : (t[i] = a[i]));
        }
      }
    }
      ...
      if (
        ...
        if (0 === t) o[e ? "scrollLeft" : "scrollTop"] = -c;
          ...
          if (!a.support.smoothScroll)
            return (
              O({ swiper: a, targetPosition: -c, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e = 0, t = this.params.speed, s = !0, i, n) {
      ...
      if (o.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!a.support.smoothScroll)
            return (
              O({ swiper: a, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  function j(e) {
    ...
    c && l.target && l.target.shadowRoot && p && (d = S(p[0]));
      ...
      document.querySelector(".swiper") &&
        new re(".swiper", {
          ...
          breakpoints: {
            ...
            768: { slidesPerView: 3, spaceBetween: 20, spaceBetween: 20 },
            992: { slidesPerView: 3, spaceBetween: 20, spaceBetween: 30 },
            1268: { slidesPerView: 4, spaceBetween: 30, spaceBetween: 30 },
          },
          on: {},
        });
  });
  ...
  const fe = document.querySelector(".icon-menu"),
    me = document.querySelector(".menu__body");
  fe.addEventListener("click", function (e) {
    me.classList.toggle("_active");
  });
  let ge,
    ve = document.querySelectorAll(".addfile__input");
  document.querySelectorAll(".addfile__button"),
    document.querySelectorAll(".addfile__box");
  document.body.addEventListener("click", function (e) {
    const t = e.target;
    t.closest(".addfile__button") && (ge = t.nextElementSibling);
  }),
    document.body.addEventListener("input", function (e) {
      ve.forEach((e) => {
        if ("" != e.value) {
          ...
          (i.className = "addfile__format"),
            (i.innerHTML = t.slice(s + 1, t.length)),
            ge.prepend(i),
            (e.value = "");
        }
      });
    ...
    document.addEventListener("click", function (e) {
      const t = e.target;
      t.closest(".addfile__button") &&
        t.nextElementSibling.classList.toggle("_active");
    });
  const be = document.querySelectorAll(".review__time");
  let ye = Object.values(be),
    we = new Date().toLocaleDateString();
